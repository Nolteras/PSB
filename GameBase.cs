...
public class Blacksmt
{
    ...
    public void GoToBlacksmt(int ProspBlacksm)
    {
        PropsBlack = ProspBlacksm;
        Console.Clear();
        Console.WriteLine(new string('#', 80));
        Console.WriteLine("Вы приходите в кузню.");


        switch (PropsBlack)
        {
            case 0:
                Console.WriteLine("Бедная кузня");
                break;
            case 1:
                Console.WriteLine("Не очень бендая кузня");
                break;
            case 2:
                Console.WriteLine("Нормальная такая кузня");
                break;
            case 3:
                Console.WriteLine("Богатая кузня");
                break;
        }
        Console.WriteLine("");
        Console.WriteLine(new string('#', 80));
        Console.WriteLine("");
        Console.WriteLine("Сделать что-то - Spisok");
        string choice;
        Console.Write("Введите букву(Регистр важен): ");
        choice = Console.ReadLine();
        ...
        void TochnoNeGoToBlacksmt()
        {
            ...
            {
                weapons.Add(new Weapon(rnd.Next(0, 2))); //TODO добавить генерацию нескольких оружий, 
            }
            Console.Clear();
            Console.WriteLine(new string('#', 80));
